...
class NodeTreeController:
    ...
    def __init__(self, action_notifier: ActionNotifier, ui_state: UIState):
        ...
        action_notifier.register(self, act.MoveSelectedNodeUp)
        action_notifier.register(self, act.MoveSelectedNodeDown)
        action_notifier.register(self, act.NewNodeNextSibling)
        action_notifier.register(self, act.TabNode)
        action_notifier.register(self, act.UntabNode)
        action_notifier.register(self, act.DeleteSelectedNodeAndSelectPrevious)
        action_notifier.register(self, act.DeleteSelectedNodeAndSelectNext)
        action_notifier.register(self, act.DiveIntoSelectedNode)
        action_notifier.register(self, act.ClimbOutOfNode)
        action_notifier.register(self, act.ToggleNodeExpanded)
        action_notifier.register(self, act.ScrollDown)
        action_notifier.register(self, act.ScrollUp)
    ...
    def determine_changes_from_action(self, action: act.Action) -> ChangeAction:
        ...
        if action.is_type(act.NavigateUp):
